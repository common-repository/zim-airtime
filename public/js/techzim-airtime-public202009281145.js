...
function tz_airtime_confirmation(form) {
	...
	var loader = document.getElementsByClassName("tz-airtime-simple-buying-form-loader");

	loader[0].style = "display: block";

	var btn_submit = document.getElementsByClassName("tz-airtime-simple-buying-form-btn");
